...
#include <memory>
#include "../../AutoCenterDesktop/widgets/cars.h"
...
QT_MOC_LITERAL(1, 5, 16), // "carsCountChanged"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 18), // "on_btn_add_clicked"
QT_MOC_LITERAL(4, 42, 18) // "on_btn_del_clicked"

    },
    "Cars\0carsCountChanged\0\0on_btn_add_clicked\0"
    "on_btn_del_clicked"
};
...
void Cars::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->carsCountChanged(); break;
        ...
        {
            using _t = void (Cars::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cars::carsCountChanged)) {
                *result = 0;
                return;
            }
        }
